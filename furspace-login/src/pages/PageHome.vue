<template>
  <q-page class="constrain q-pa-md">
    <div class="row q-col-gutter-lg">
      <div v-if="isLoggedIn" class="col-12 col-sm-8">
...
<script>
import { ref, watch } from "vue"; // Use ref for reactive data, watch for state changes
...
export default {
  ...
  created() {
    // this.getPosts();
    // Check if user is logged in initially (optional)
    this.isLoggedIn = localStorage.getItem("loggedIn") === "true";
    console.log("localStorage logged in == true");
  },
  watch: {
    isLoggedIn(newVal) {
      if (newVal) {
        // Load posts only when user logs in
        this.getPosts();
